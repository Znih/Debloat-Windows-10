...
$domains = @(
    ...
    "a.ads2.msn.com"
    "ac3.msn.com"
    "ad.doubleclick.net"           # *.doubleclick.net *doubleclick.net >> stats.g.doubleclick.net, googleads.g.doubleclick.net, pagead46.l.doubleclick.net
    "adnexus.net"
    "adnxs.com"
    "ads1.msads.net"
    "ads1.msn.com"
    ...
    "sls.update.microsoft.com"                  # no auto update
    #"sls.update.microsoft.com:443"                  # no auto update - dns? tcp.port==443?
